        ...
        <div className="container">
          <div className="privacy-section">
            ...
            <ul>
              ...
              <li><strong>רישום רכישות</strong> – לצורך שירות ואסמכתא בלבד (תחזוקה, אחסון, שמירה לצמיתות). התשלום מתבצע במלואו אצל ספקים חיצוניים (PayPal, PayPlus, Stripe); אנו לא מספקים שירות פיננסי ולא שומרים פרטי כרטיס אשראי.</li>
            </ul>
          </div>
