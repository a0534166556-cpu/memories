        ...
        <div className="container">
          <div className="privacy-section">
            ...
            <ul>
              ...
              <li><strong>מידע פיננסי</strong> – היסטוריית רכישות ותשלומים (תחזוקה, אחסון, שמירה לצמיתות) דרך PayPal. פרטי כרטיס אשראי לא נשמרים אצלנו – הטיפול בתשלום מתבצע אצל PayPal.</li>
            </ul>
          </div>
