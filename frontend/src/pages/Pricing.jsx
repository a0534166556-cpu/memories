  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        'שמירה קבועה',
        'עריכה חופשית',
        'תחזוקת אתר 15₪ לשנה (חינם בשנה הראשונה, מתחייב מהשנה השנייה)',
          ...
          <div className="pricing-faq">
            ...
            <div className="faq-grid">
              <div className="faq-item">
                ...
                <p>
                  מנוי חודשי (17₪), שנתי (120₪), הנצחה חד־פעמית (360₪) או פרימיום 3 גיגה (520₪). 
                  תחזוקת אתר 15₪ לשנה – חינם בשנה הראשונה במסלולי החד־פעמי, מתחייב מהשנה השנייה. 
                  ניתן לרכוש תוספת גיגה בכל עת (100₪ לגיגה).
                </p>
              </div>
              <div className="faq-item">
