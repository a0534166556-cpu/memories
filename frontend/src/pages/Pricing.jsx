...
function Pricing() {
  ...
  const plans = [
    ...
    {
      id: 'lifetime-no-edit',
      name: 'הנצחה חד פעמית (בלי עריכה)',
      price: 375,
      period: 'חד-פעמי',
      description: 'שמירה חד פעמית ללא אפשרות עריכה',
      features: [
        'שמירה קבועה',
        'תחזוקת אתר 45₪ (כלול)',
        'עד 2 גיגה תמונות וסרטונים',
    ...
    },
    {
      ...
      price: 699,
      period: 'חד-פעמי',
      description: 'שמירה חד פעמית עם 7 גיגה אחסון',
      features: [
        'שמירה קבועה',
        'עריכה חופשית',
        'תחזוקת אתר 45₪ (כלול)',
        'עד 7 גיגה תמונות וסרטונים',
        'גיבוי',
        'תמיכה מלאה'
      ],
      limitations: [],
            ...
            <div className="faq-grid">
              <div className="faq-item">
                ...
                <p>
                  ...
                  הנצחה חד פעמית בלי עריכה (375₪) כוללת תחזוקת אתר 45₪ ועד 2 גיגה מדיה. 
                  הנצחה חד פעמית עם עריכה (445₪) כוללת את כל התכונות + עריכה חופשית, תחזוקת אתר ועד 2 גיגה.
                </p>
              </div>
              <div className="faq-item">
              ...
              <div className="faq-item">
                ...
                <p>
                  אפשר לשדרג מהנצחה בלי עריכה (375₪) להנצחה עם עריכה (445₪) בהשלמת ההפרש. 
